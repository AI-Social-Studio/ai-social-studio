  ...
  return (
    <section className="space-y-6">
      <div className="rounded-3xl border border-violet-200 bg-violet-50 p-8">
        <div className="mb-3 inline-flex rounded-full border border-violet-300 bg-white px-3 py-1 text-xs font-medium uppercase tracking-wider text-violet-700">
          Admin access
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          <div className="text-xs font-medium uppercase tracking-wider text-gray-400">Resolved role</div>
          <div className="mt-2 text-2xl font-semibold text-gray-900">{auth.role}</div>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          <div className="text-xs font-medium uppercase tracking-wider text-gray-400">Detection source</div>
          <div className="mt-2 text-2xl font-semibold text-gray-900">{auth.roleSource}</div>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          <div className="text-xs font-medium uppercase tracking-wider text-gray-400">Account</div>
